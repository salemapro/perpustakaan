...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/logo-pgri.png" height="80px" width="150px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
