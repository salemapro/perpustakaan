...
if ($_GET['aksi'] == "masuk") {
    ...
    if ($cek > 0) {
        ...
        if ($row['role'] == "Admin") {
            ...
            // Jika level user yang login adalah kepsek maka arahkan user kehalaman kepsek
            $_SESSION['id_user'] = $row['id_user'];
            $_SESSION['username'] = $username;
            $_SESSION['fullname'] = $row['fullname'];
            ...
            echo "Redirecting to: http://localhost/Perpustakaan/app/kepsek/dashboard";
            header("Location: http://localhost/Perpustakaan/app/kepsek/dashboard");
