...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/logo-pgri.png" width="200px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">

            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMA PGRI PARAKANMUNCANG</h2>
