            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title" style="font-family: 'Quicksand', sans-serif; font-weight: bold;">Data Kepala Sekolah</h3>
                        <div class="form-group m-b-2 text-right" style="margin-top: -20px; margin-bottom: -5px;">
                            <button type="button" onclick="tambahAdmin()" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Kepala Sekolah</button>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            $no = 1;
                            $query = mysqli_query($koneksi, "SELECT * FROM user WHERE role = 'Kepsek'");
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="pages/function/KepalaSekolah.php?act=hapus&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm btn-del" onclick="hapusAnggota()"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Admin -->
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="border-radius: 5px;">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" style="font-family: 'Quicksand', sans-serif; font-weight: bold;">Edit Kepala Sekolah</h4>
                                                </div>
                                                <form action="pages/function/KepalaSekolah.php?act=edit" enctype="multipart/form-data" method="POST">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 5px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="font-family: 'Quicksand', sans-serif; font-weight: bold;">Tambah Kepala Sekolah</h4>
            </div>
            <form action="pages/function/KepalaSekolah.php?act=tambah" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <!-- -->
...
<script>
    $('.btn-del').on('click', function(e) {
        ...
        swal({
                icon: 'warning',
                title: 'Peringatan',
                text: 'Apakah anda yakin ingin menghapus data kepala sekolah ini ?',
                buttons: true,
                dangerMode: true,
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal({
                        icon: 'error',
                        title: 'Dibatalkan',
                        text: 'Data Kepala Sekolah tersebut tetap aman !'
                    })
                }
            });
    })
